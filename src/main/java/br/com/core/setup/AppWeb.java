...
public class AppWeb extends Drivers {
    ...
    public AppWeb() {
        ...
        this.recordVideo = Boolean.parseBoolean(setupProperties.getProps().getProperty("record.video").toLowerCase());
    }
    ...
    private DesiredCapabilities chromeCapabilities(DesiredCapabilities desiredCapabilities) {
        ...
        desiredCapabilities.setCapability("recordVideo", this.recordVideo);
